# EnergyCo WhatsApp Rescheduling Demo

A mobile web demo simulating a WhatsApp conversation between a EnergyCo customer and an AI agent for rescheduling a home charging station installation appointment.
...
Run locally — open `index.html` in a browser (or serve the folder, e.g. `python3 -m http.server`). Not yet published to a hosting URL.
